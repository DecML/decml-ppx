(* OASIS_START *)
(* DO NOT EDIT (digest: 178bfbfb26e442f5fde97c62593849af) *)
...
let package_default =
  {
     ...
     includes =
       [
          ("test/ppx", ["lib"; "ppx"]);
          ("ppx", ["lib"]);
          ("examples/regression_mixture", ["lib"]);
          ("examples/neural_network", ["lib"]);
          ("examples/multivariate_regression", ["lib"]);
          ("examples/linear_regression", ["lib"]);
          ("examples/confidence_interval", ["lib"])
       ]
  }
  ;;
...
let () =
  dispatch
    (fun hook ->
       ...
       | After_rules ->
         (* `ppx_slap' in `_tags' *)
         flag ["ocaml"; "compile"; "ppx_decml"] &
         S [A "-ppx"; A "ppx/decml_ppx_extension.native"]
       | _ -> ())
