...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1cfbac638bef39615de3514067b1b5ec) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ppx_extension", []))];
     ...
     package =
       {
          oasis_version = "0.4";
          ocaml_version = Some (OASISVersion.VGreaterEqual "4.05");
          version = "0.1";
          license =
          ...
          homepage = Some "https://github.com/decml/decml-ppx";
          bugreports = None;
          synopsis =
            "An experimental library for transparent parameter management\nof machine learning models, via abductive decoupling.";
          description =
            Some
              [
                 OASISText.Para
                   "DecML is an experimental library for achieving a decoupling between a supervised machine learning model and its parameters. Models are defined in a custom ppx syntax, with the DecML extension managing the decoupling itself. The library also defines several modules for utility functions."
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build ppx_decml";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "ppx";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "decml"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "decml_ppx_extension.ml"
                   });
               Test
                 ({
                     cs_name = "test_ppx_extension";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      test_working_directory = Some "test/ppx/";
                      test_run =
                        [
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "decml";
                           InternalLibrary "decml_ppx";
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_ppx_extension.ml"
                   });
               Flag
                 ({
                     cs_name = "examples";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/confidence_interval";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "decml";
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "decml_confidence_interval.ml"
                   });
               Executable
                 ({
                     cs_name = "linear_regression";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/linear_regression";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "decml";
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "decml_linear_regression.ml"
                   });
               Executable
                 ({
                     cs_name = "multivariate_regression";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/multivariate_regression";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "decml";
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "decml_multivariate_regression.ml"
                   });
               Executable
                 ({
                     cs_name = "neural_network";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/neural_network";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "decml";
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "decml_neural_network.ml"
                   });
               Executable
                 ({
                     cs_name = "regression_mixture";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/regression_mixture";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "decml";
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "decml_regression_mixture.ml"
                   });
               SrcRepo
                 ({
                     cs_name = "head";
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/DecML/decml-ppx.git";
                      src_repo_browser =
                        Some "https://github.com/DecML/decml-ppx";
     ...
     oasis_digest = Some "\167\031\138l*\233p>\168S\216s-d\002\146";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
